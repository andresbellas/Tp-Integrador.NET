        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <asp:LinkButton 
              ...
              style="font-size:1.2rem;">Gestión General</asp:LinkButton>
          </li>
          <li class="nav-item">
            <asp:LinkButton 
              runat="server" 
              ...
              style="font-size:1.2rem;">Historial de Pagos</asp:LinkButton>
          </li>
          <li class="nav-item">
            <asp:LinkButton 
              runat="server" 
              ...
              style="font-size:1.2rem;">Historial de Pedidos</asp:LinkButton>
          </li>
        </ul>
      </div>
    </div>
